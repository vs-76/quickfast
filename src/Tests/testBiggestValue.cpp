...
namespace{
  ...
  void validateMessage1(Messages::Message & message, const std::string buffer)
  {
    ...
    EXPECT_EQ((value->toInt32()), (2147483647));
    ...
    EXPECT_EQ((value->toUInt32()), (4294967295UL));
    ...
    EXPECT_EQ((value->toInt64()), (9223372036854775807LL));
    ...
    EXPECT_EQ((value->toUInt64()), (18446744073709551615ULL));
    ...
    EXPECT_EQ((value->toDecimal()), (Decimal (9223372036854775807LL, 63)));
    ...
    EXPECT_EQ((value->toAscii()), (buffer.c_str()));
    ...
    EXPECT_EQ((value->toUtf8()), (buffer.c_str()));
    ...
    EXPECT_EQ((value->toByteVector()), (buffer.c_str()));
    ...
    EXPECT_EQ((value->toInt32()), (2147483647L));
    ...
    EXPECT_EQ((value->toAscii()), ("$buffer"));
    ...
    EXPECT_EQ((value->toByteVector()), ("$buffer"));
...
TEST(QuickFAST, TestBiggestValue)
{

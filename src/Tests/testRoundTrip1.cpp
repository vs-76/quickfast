...
namespace{
  void validateMessage1(Messages::Message & message)
  {
    ...
    EXPECT_EQ((value->toDecimal()), (Decimal (12345, -4)));
    ...
    EXPECT_EQ((value->toAscii()), ("asciistringblabla"));
    ...
    EXPECT_EQ((value->toUtf8()), ("utf8stringblabla"));
    ...
    EXPECT_EQ((value->toAscii()), ("constant asciistring"));
    ...
    EXPECT_EQ((value->toUtf8()), ("constant utf8string"));
    ...
    EXPECT_EQ((value->toInt64()), (-6000000000LL));
    ...
    EXPECT_EQ((value->toUInt64()), (6000000000ULL));
    ...
    EXPECT_EQ((value->toDecimal()), (Decimal(54321, -4)));
    ...
    EXPECT_EQ((value->toAscii()), ("default asciistring"));
    ...
    EXPECT_EQ((value->toUtf8()), ("default utf8string"));
    ...
    EXPECT_EQ((value->toByteVector()), ("default bytevectorblabla"));
    ...
    EXPECT_EQ((value->toAscii()), ("blabla"));
    ...
    EXPECT_EQ((value->toByteVector()), ("blabla"));
  ...
  void test (const std::string& xml)
  {
    ...
    EXPECT_TRUE(templateStream.good());
